...
fn si_other_numbers() {
    ...
    test_prefs("nn", "SimpleSpeak", vec![("DecimalSeparators", ","), ("BlockSeparators", ".")], expr, 
...
fn one_neuter_unit() {
    ...
    test("nn", "ClearSpeak", expr, "ett minutt");
    test("nn", "SimpleSpeak", expr, "ett minutt");
}
...
fn one_masculine_feminine_unit() {
    ...
    test("nn", "ClearSpeak", expr, "1 time");
    test("nn", "SimpleSpeak", expr, "1 time");
}
...
fn half_neuter_unit() {
    ...
    test("nn", "ClearSpeak", expr, "ett halvt sekund");
    test("nn", "SimpleSpeak", expr, "ett halvt sekund");
...
fn half_masculine_feminine_unit() {
    ...
    test("nn", "ClearSpeak", expr, "1 halv liter");
    test("nn", "SimpleSpeak", expr, "1 halv liter");
}
...
fn one_third_neuter_unit() {
    ...
    test("nn", "ClearSpeak", expr, "ett tredjedels buesekund");
    test("nn", "SimpleSpeak", expr, "ett tredjedels buesekund");
}
...
fn one_third_masculine_feminine_unit() {
    ...
    test("nn", "ClearSpeak", expr, "1 tredjedels meter");
    test("nn", "SimpleSpeak", expr, "1 tredjedels meter");
}
...
fn five_thirds_unit() {
    ...
    test("nn", "ClearSpeak", expr, "5 tredjedels time");
    test("nn", "SimpleSpeak", expr, "5 tredjedels time");
}
...
fn four_eighths_unit() {
    ...
    test("nn", "ClearSpeak", expr, "4 åttedels gram");
    test("nn", "SimpleSpeak", expr, "4 åttedels gram");
}
...
fn six_ninths_unit() {
    ...
    test("nn", "ClearSpeak", expr, "6 nidels time");
    test("nn", "SimpleSpeak", expr, "6 nidels time");
}
...
fn mixed_fraction__half_neuter_unit() {
    ...
    test("nn", "ClearSpeak", expr, "3 og ett halvt, minutt");
    test("nn", "SimpleSpeak", expr, "3 og ett halvt, minutt");
}
...
fn mixed_fraction__half_masculine_feminine_unit() {
    ...
    test("nn", "ClearSpeak", expr, "3 og 1 halv, time");
    test("nn", "SimpleSpeak", expr, "3 og 1 halv, time");
}
...
fn mixed_fractions_third_neuter_unit() {
    ...
    test("nn", "ClearSpeak", expr, "ett og ett tredjedels, minutt");
    test("nn", "SimpleSpeak", expr, "ett og ett tredjedels, minutt");
}
...
fn mixed_fractions_third_masculine_feminine_unit() {
    ...
    test("nn", "ClearSpeak", expr, "1 og 1 tredjedels, time");
    test("nn", "SimpleSpeak", expr, "1 og 1 tredjedels, time");
}
...
fn mixed_fractions_two_and_two_thirds_unit() {
    ...
    test("nn", "ClearSpeak", expr, "2 og 2 tredjedels, time");
    test("nn", "SimpleSpeak", expr, "2 og 2 tredjedels, time");
}
...
fn mixed_fractions_four_and_five_sevenths_unit() {
    ...
    test("nn", "ClearSpeak", expr, "4 og 5 sjudels, minutt");
    test("nn", "SimpleSpeak", expr, "4 og 5 sjudels, minutt");
}
...
fn fraction_with_units_neuter_unit() {
    ...
    test("nn", "ClearSpeak", expr, "ett halvt gram per time");
    test("nn", "SimpleSpeak", expr, "ett halvt gram per time");
}
...
fn fraction_with_units_masculine_feminine_unit() {
    ...
    test("nn", "ClearSpeak", expr, "1 halv meter per sekund");
    test("nn", "SimpleSpeak", expr, "1 halv meter per sekund");
}
...
fn fraction_with_units_2_neuter_unit() {
    ...
    test("nn", "ClearSpeak", expr, "brøken med teller ett gram; og nevner 3 timer");
    test("nn", "SimpleSpeak", expr, "brøk, ett gram, over, 3 timer, slutt brøk");
}
...
fn fraction_with_units_2_masculine_feminine_unit() {
    ...
    test("nn", "ClearSpeak", expr, "brøken med teller 1 meter; og nevner 3 sekunder");
    test("nn", "SimpleSpeak", expr, "brøk, 1 meter, over, 3 sekunder, slutt brøk");
}
...
fn fraction_not_ordinal_units_neuter() {
    ...
    test("nn", "ClearSpeak", expr, "3 over 11 minutter");
    test("nn", "SimpleSpeak", expr, "3 over 11, minutter");
}
...
fn fraction_not_ordinal_units_masculine_feminine() {
    ...
    test("nn", "ClearSpeak", expr, "3 over 11 timer");
    test("nn", "SimpleSpeak", expr, "3 over 11, timer");
}
...
fn fraction_not_ordinal_2_units_neuter() {
    ...
    test("nn", "ClearSpeak", expr, "7 over 21 minutter");
    test("nn", "SimpleSpeak", expr, "7 over 21, minutter");
}
...
fn fraction_not_ordinal_2_units_masculine_feminine() {
    ...
    test("nn", "ClearSpeak", expr, "7 over 21 timer");
    test("nn", "SimpleSpeak", expr, "7 over 21, timer");
}
...
fn one_neuter_unit_prefix() {
    ...
    test("nn", "ClearSpeak", expr, "ett milli-gram");
    test("nn", "SimpleSpeak", expr, "ett milli-gram");
}
...
fn one_masculine_feminine_unit_prefix() {
    ...
    test("nn", "ClearSpeak", expr, "1 mikro-meter");
    test("nn", "SimpleSpeak", expr, "1 mikro-meter");
}
...
fn half_neuter_unit_prefix() {
    ...
    test("nn", "ClearSpeak", expr, "ett halvt nano-sekund");
    test("nn", "SimpleSpeak", expr, "ett halvt nano-sekund");
}
...
fn third_neuter_unit_prefix() {
    ...
    test("nn", "ClearSpeak", expr, "ett tredjedels milli-tonn");
    test("nn", "SimpleSpeak", expr, "ett tredjedels milli-tonn");
}
...
fn mixed_fractions_third_masculine_feminine_unit_prefix() {
    ...
    test("nn", "ClearSpeak", expr, "1 og 1 tredjedels, desi-newton");
    test("nn", "SimpleSpeak", expr, "1 og 1 tredjedels, desi-newton");
}
...
fn mixed_fractions_four_and_five_sevenths_unit_prefix() {
    ...
    test("nn", "ClearSpeak", expr, "4 og 5 sjudels, nano-buesekund");
    test("nn", "SimpleSpeak", expr, "4 og 5 sjudels, nano-buesekund");
}
...
fn fraction_not_ordinal_units_neuter_prefix() {
    ...
    test("nn", "ClearSpeak", expr, "7 over 21 nano-sekunder");
    test("nn", "SimpleSpeak", expr, "7 over 21, nano-sekunder");
}
...
fn fraction_not_ordinal_units_masculine_feminine_prefix() {
    ...
    test("nn", "ClearSpeak", expr, "7 over 21 milli-liter");
    test("nn", "SimpleSpeak", expr, "7 over 21, milli-liter");
}
...
fn acceleration_half() {
    ...
    test("nn", "ClearSpeak", expr, "1 halv meter per sekund i andre");
    test("nn", "SimpleSpeak", expr, "1 halv meter per sekund i andre");
}
...
fn acceleration_half_one_fraction() {
    ...
    test("nn", "ClearSpeak", expr, "brøken med teller 1 meter; og nevner 2 sekunder i andre");
    test("nn", "SimpleSpeak", expr, "brøk, 1 meter, over, 2 sekunder i andre, slutt brøk");
}
...
fn acceleration_four_sevenths() {
    ...
    test("nn", "ClearSpeak", expr, "4 sjudels meter per sekund i andre");
    test("nn", "SimpleSpeak", expr, "4 sjudels meter per sekund i andre");
}
...
fn density_thirds() {
    ...
    test("nn", "ClearSpeak", expr, "ett tredjedels, kilo-gram per meter i tredje");
    test("nn", "SimpleSpeak", expr, "ett tredjedels, kilo-gram per meter i tredje");
}
...
fn density_thirds_one_fraction() {
    ...
    test("nn", "ClearSpeak", expr, "brøken med teller; ett kilo-gram; og nevner 3 meter i tredje");
    test("nn", "SimpleSpeak", expr, "brøk, ett kilo-gram, over, 3 meter i tredje, slutt brøk");
}
...
fn density_two_fifths() {
    ...
    test("nn", "ClearSpeak", expr, "2 femtedels, kilo-gram per meter i tredje");
    test("nn", "SimpleSpeak", expr, "2 femtedels, kilo-gram per meter i tredje");
}
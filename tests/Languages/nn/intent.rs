...
fn infix_intent() {
    ...
    test("nn", "SimpleSpeak", expr, "x testing y testing z testing 2");
}
...
fn function_intent() {
    ...
    test("nn", "SimpleSpeak", expr, "testing av x, y, z, 2");
}
...
fn function_one_arg_intent() {
    ...
    test("nn", "SimpleSpeak", expr, "testing av x");
}

#[test]
fn silent_intent_mi() {
    let expr = "<math> <mn>2</mn> <mi intent=':silent'>x</mi></math>";
    test("nn", "SimpleSpeak", expr, "2");
    test("nn", "ClearSpeak", expr, "2");
}
...
fn silent_intent_msup() {
    ...
    test("nn", "SimpleSpeak", expr, "stor h 2");
    test("nn", "ClearSpeak", expr, "stor h 2");
}
...
fn intent_prob_x() {
    ...
    test("nn", "ClearSpeak", expr, "sannsynligheten av x");
}

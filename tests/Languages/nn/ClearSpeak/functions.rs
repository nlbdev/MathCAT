...
fn trig_fourth() {
    ...
    test("nn", "ClearSpeak", expr, "sekans opphøyd i 4, av x");
}
...
fn trig_power_other() {
    ...
    test("nn", "ClearSpeak", expr, "sinus hyperbolicus opphøyd i n minus 1, av x");
}
...
fn simple_log_with_base() {
    ...
    test("nn", "ClearSpeak", expr, "logaritmen med grunntall b, av x");
}
...
fn normal_log_with_base() {
    ...
    test("nn", "ClearSpeak", expr, "logaritmen med grunntall b, av; startparentes; x pluss y; sluttparentes");
}
...
fn explicit_times_with_parens() {
    let expr = "<math><mrow><mi>t</mi><mo>&#x2062;</mo><mrow><mo>(</mo><mi>x</mi><mo>)</mo></mrow></mrow></math>";
    test("nn", "ClearSpeak", expr, "t ganger x");
}
...
fn times_following_paren() {
    ...
    test("nn", "ClearSpeak", expr, "2 ganger 3");
}
...
fn times_sqrt() {
    ...
    test("nn", "ClearSpeak", expr, "kvadratroten av a; ganger kvadratroten av b; er lik kvadratroten av a b");
}
...
fn explicit_times_more_implied_times() {
    let expr = "<math><mrow><mi>t</mi><mo>&#x2062;</mo><mrow><mi>x</mi></mrow></mrow></math>";
    test_ClearSpeak("nn", "ClearSpeak_ImpliedTimes", "MoreImpliedTimes",expr, "t ganger x");
}
...
/*
    ...
    */
    ...
    fn no_parens_number() {
        ...
        test("nn", "ClearSpeak", expr, "25 ganger x");
    }

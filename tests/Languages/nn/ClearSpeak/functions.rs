...
fn trig_names() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "sinus x pluss cosinus y pluss tangens z pluss sekans alfa, pluss cosekans fi, pluss cotangens fi")?;
    return Ok(());
...
fn hyperbolic_trig_names() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "sinus hyperbolicus av x, pluss \
...
fn inverse_trig() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "invers sinus av x")?;
    return Ok(());
...
fn inverse_trig_trig_inverse() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Trig", "TrigInverse",expr,
        "tangens invers av x")?;
        return Ok(());
...
fn inverse_trig_arc() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Trig", "ArcTrig",expr,
...
fn trig_squared() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "sinus i andre av x")?;
    return Ok(());
...
fn trig_cubed() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "tangens i tredje av x")?;
    return Ok(());
...
fn trig_fourth() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "sekans opphøgd i 4, av x")?;
    return Ok(());
...
fn trig_power_other() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "sinus hyperbolicus opphøgd i n minus 1, av x")?;
    return Ok(());
...
fn simple_log() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "log av x")?;
    return Ok(());
...
fn normal_log() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "log av; startparentes; x pluss y; sluttparentes")?;
    return Ok(());
...
fn simple_log_with_base() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "logaritmen med grunntal b, av x")?;
    return Ok(());
...
fn normal_log_with_base() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "logaritmen med grunntal b, av; startparentes; x pluss y; sluttparentes")?;
    return Ok(());
...
fn simple_ln() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "l n av x")?;
    return Ok(());
...
fn normal_ln() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "l n av; startparentes; x pluss y; sluttparentes")?;
    return Ok(());
...
fn simple_natural_log() -> Result<()> {
    let expr = "<math> <mrow>  <mi>ln</mi><mi>x</mi></mrow> </math>";
    test_ClearSpeak("nn", "ClearSpeak_Log", "LnAsNaturalLog",expr,
        "den naturlege logaritmen av x")?;
        return Ok(());
...
fn natural_log() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Log", "LnAsNaturalLog",expr,
        "den naturlege logaritmen av; startparentes; x pluss y; sluttparentes")?;
        return Ok(());
...
fn explicit_function_call_with_parens() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "t av x")?;
    return Ok(());
...
fn explicit_times_with_parens() -> Result<()> {
    let expr = "<math><mrow><mi>t</mi><mo>&#x2062;</mo><mrow><mo>(</mo><mi>x</mi><mo>)</mo></mrow></mrow></math>";
    test("nn", "ClearSpeak", expr, "t gongar x")?;
    return Ok(());
...
fn test_functions_none_pref() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Functions", "None",expr,
        "log av; startparentes; x pluss y; sluttparentes; pluss; f gongar; startparentes; x pluss y; sluttparentes")?;
        return Ok(());
...
fn test_functions_none_pref_multiple_args() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Functions", "None",expr,
        "stor b gongar; startparentes; 2 komma, 6; sluttparentes")?;
        return Ok(());
...
fn times_following_paren() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "2 gongar 3")?;
    return Ok(());
...
fn times_sqrt() -> Result<()> {
    ...
    test("nn", "ClearSpeak", expr, "kvadratrota av a; gongar kvadratrota av b; er lik kvadratrota av a b")?;
    return Ok(());
...
fn more_implied_times() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_ImpliedTimes", "MoreImpliedTimes",expr,
        ", startparentes; 2 gongar x; sluttparentes i andre")?;
        return Ok(());
...
fn explicit_times_more_implied_times() -> Result<()> {
    let expr = "<math><mrow><mi>t</mi><mo>&#x2062;</mo><mrow><mi>x</mi></mrow></mrow></math>";
    test_ClearSpeak("nn", "ClearSpeak_ImpliedTimes", "MoreImpliedTimes",expr, "t gongar x")?;
    return Ok(());
...
fn explicit_times_none_simple_right() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_ImpliedTimes", "None",
...
/*
    ...
    */
    ...
    fn no_parens_number() -> Result<()> {
        ...
        test("nn", "ClearSpeak", expr, "25 gongar x")?;
        return Ok(());
    ...
    fn no_parens_monomial() -> Result<()> {
        ...
        test("nn", "ClearSpeak", expr, "b; startparentes; x y, sluttparentes")?;
        return Ok(());
    ...
    fn no_parens_negative_number() -> Result<()> {
        ...
        test("nn", "ClearSpeak", expr, "2 pluss minus 2")?;
        return Ok(());
    ...
    fn no_parens_negative_number_with_var() -> Result<()> {
        ...
        test("nn", "ClearSpeak", expr, "minus 2 x pluss 1")?;
        return Ok(());
    ...
    fn parens_superscript() -> Result<()> {
        ...
        test("nn", "ClearSpeak", expr, ", startparentes; 2 x, sluttparentes i andre")?;
        return Ok(());
    ...
    fn no_parens_fraction() -> Result<()> {
        ...
        test("nn", "ClearSpeak", expr, "2 pluss 1 halv")?;
        return Ok(());
    ...
    test_ClearSpeak("nn", "ClearSpeak_Paren", "Interval",expr,
    "det opne intervallet frå c til d")?;
    return Ok(());
...
#[test]
    ...
    test_ClearSpeak("nn", "ClearSpeak_Paren", "Interval ",expr,
    "det halvopne intervallet frå og med c til d")?;
    return Ok(());
...
fn parens_interval_open_closed() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Paren", "Interval ",expr,
    "det halvopne intervallet frå c til og med d")?;
    return Ok(());
...
test_ClearSpeak("nn", "ClearSpeak_Paren", "Interval ",expr,
"det lukka intervallet frå c til d")?;
return Ok(());
    ...
    test_ClearSpeak("nn", "ClearSpeak_Paren", "Interval ",expr,
    "det opne intervallet frå minus uendeleg til d")?;
    return Ok(());
    ...
    test_ClearSpeak("nn", "ClearSpeak_Paren", "Interval ",expr,
    "det halvopne intervallet frå minus uendeleg til og med d")?;
    return Ok(());
...
fn parens_interval_open_open_infinity() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Paren", "Interval ",expr,
    "det opne intervallet frå c til uendeleg")?;
    return Ok(());
...
fn parens_interval_closed_open_infinity() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Paren", "Interval ",expr,
"det halvopne intervallet frå og med c til uendeleg")?;
return Ok(());
...
fn parens_interval_neg_infinity_to_infinity() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Paren", "Interval ",expr,
    "det opne intervallet frå minus uendeleg til uendeleg")?;
    return Ok(());
...
fn parens_interval_neg_infinity_to_pos_infinity() -> Result<()> {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Paren", "Interval ",expr,
    "det opne intervallet frå minus uendeleg til pluss uendeleg")?;
    return Ok(());

...
fn complex() {
    ...
    test("nn", "ClearSpeak", expr, "de komplekse tallene");
}
...
fn natural() {
    ...
    test("nn", "ClearSpeak", expr, "de naturlige tallene");
}
...
fn rationals() {
    ...
    test("nn", "ClearSpeak", expr, "de rasjonale tallene");
}
...
fn reals() {
    ...
    test("nn", "ClearSpeak", expr, "de reelle tallene");
}
...
fn integers() {
    ...
    test("nn", "ClearSpeak", expr, "heltallene");
}
...
fn msup_positive_integers() {
    ...
    test("nn", "ClearSpeak", expr, "de positive heltallene");
}
...
fn msup_negative_integers() {
    ...
    test("nn", "ClearSpeak", expr, "de negative heltallene");
}
...
fn msup_positive_rationals() {
    ...
    test("nn", "ClearSpeak", expr, "de positive rasjonale tallene");
}
...
fn msup_negative_rationals() {
    ...
    test("nn", "ClearSpeak", expr, "de negative rasjonale tallene");
}
...
fn empty_set() {
    ...
    test("nn", "ClearSpeak", expr, "den tomme mengden");
}
...
fn single_element_set() {
    ...
    test("nn", "ClearSpeak", expr, "mengden 12");
}
...
fn multiple_element_set() {
    ...
    test("nn", "ClearSpeak", expr, "mengden 5 komma, 10 komma, 15");
}
...
fn set_with_colon() {
    ...
    test("nn", "ClearSpeak", expr, "mengden av alle x slik at x er større enn 2");
}
...
fn element_under_sum() {
    ...
    test("nn", "ClearSpeak", expr,
                    "sum over i i heltallene, av; brøken med teljar 1; og nemnar i i andre");
}
...
fn complicated_set_with_colon() {
    ...
    test("nn", "ClearSpeak", expr, "mengden av alle x i heltallene slik at 2 er mindre enn x er mindre enn 7");
}
...
fn element_under_sum_member() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_SetMemberSymbol", "Member",
                expr, "sum over i tilhører heltallene, av; brøken med teljar 1; og nemnar i i andre");
}
...
fn element_under_sum_element() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_SetMemberSymbol", "Element",
                expr, "sum over i er et element i heltallene, av; brøken med teljar 1; og nemnar i i andre");
}
...
fn element_under_sum_in() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_SetMemberSymbol", "In",
                expr, "sum over i i heltallene, av; brøken med teljar 1; og nemnar i i andre");
}
...
fn set_member_woall() {
    let expr = "<math>
            ...
            test_ClearSpeak_prefs("nn", vec![("ClearSpeak_SetMemberSymbol", "Member"), ("ClearSpeak_Sets", "woAll")],
...
fn multiple_element_set_woall() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Sets", "woAll", expr, "mengden 5 komma, 10 komma, 15");
}
...
fn multiple_element_set_silent_bracket() {
    let expr = "<math>
            ...
            test_ClearSpeak("nn", "ClearSpeak_Sets", "SilentBracket", expr, "5 komma, 10 komma, 15");
        }
...
fn silent_bracket() {
    let expr = "<math>
            ...
            test_ClearSpeak("nn", "ClearSpeak_Sets", "SilentBracket", expr,

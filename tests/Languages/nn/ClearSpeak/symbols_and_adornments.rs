...
fn multiplication_by() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_MultSymbolX", "By", expr, "2 ganger 3");
}
...
fn multiplication_cross() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_MultSymbolX", "Cross", expr, "u kryss v");
}
...
fn ellipses_auto_start() {
    ...
    test("nn", "ClearSpeak", expr, "prikk prikk prikk komma, minus 2 komma, minus 1 komma, 0");
}
...
fn ellipses_auto_end() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Ellipses", "Auto", expr, "1 komma, 2 komma, 3 komma, prikk prikk prikk");
}
...
fn ellipses_auto_middle() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Ellipses", "Auto", expr,
...
fn ellipses_and_so_on_start() {
    let expr = "<math>
        ...
        test_ClearSpeak("nn", "ClearSpeak_Ellipses", "AndSoOn", expr, "prikk prikk prikk komma, minus 2 komma, minus 1 komma, 0");
}
...
fn ellipses_and_so_on_end() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Ellipses", "AndSoOn", expr, "1 komma, 2 komma, 3 og så videre");
}
...
fn ellipses_and_so_on_middle() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_Ellipses", "AndSoOn", expr,
...
fn vertical_line_auto() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_VerticalLine", "Auto", expr,
            "3 deler 6");
}
...
fn vertical_line_divides() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_VerticalLine", "Divides", expr,
            "3 deler 6");
}
    ...
    fn vertical_line_given() {
        ...
        test_ClearSpeak("nn", "ClearSpeak_VerticalLine", "Given", expr,
                "3, gitt 6");
    }
    ...
    fn vertical_line_probability_given() {
        ...
        test_ClearSpeak_prefs("nn", vec![("ClearSpeak_VerticalLine", "Given"), ("ClearSpeak_ImpliedTimes", "None")]
...
fn vertical_line_set_such_that() {
    ...
    test_ClearSpeak("nn", "ClearSpeak_VerticalLine", "SuchThat", expr,
            "mengden av alle x slik at x er større enn 0");
}

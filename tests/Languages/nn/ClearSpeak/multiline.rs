...
fn case_1() {
  let expr = "<math>
   ...
   ";
   test_ClearSpeak("nn", "ClearSpeak_MultiLineLabel", "Auto", expr,
...
fn equation_plus_at_start() {
  let expr = "<math>
   ...
   ";
   test_ClearSpeak("nn", "ClearSpeak_MultiLineLabel", "Auto", expr, "2 rader; \
                rad 1; x pluss y er lik 7; \
                rad 2; 2 x, pluss 3 y, er lik 17");
}
...
fn equation_case() {
   ...
   ";
   test_ClearSpeak("nn", "ClearSpeak_MultiLineLabel", "Case", expr, 
...
fn equation_constraint() {
  let expr = "<math>
   ...
   ";
   test_ClearSpeak("nn", "ClearSpeak_MultiLineLabel", "Constraint", expr, "2 betingelser; \
...
fn equation_equation() {
   ...
   ";
   test_ClearSpeak("nn", "ClearSpeak_MultiLineLabel", "Equation", expr, "2 likninger; \
...
fn equation_line() {
   ...
   ";
   test_ClearSpeak("nn", "ClearSpeak_MultiLineLabel", "Line", expr, "2 rader; \
                rad 1; x pluss y er lik 7; \
                rad 2; 2 x pluss 3 y; er lik 17");
}
...
fn equation_none() {
   ...
   ";
   test_ClearSpeak("nn", "ClearSpeak_MultiLineLabel", "None", expr,
...
fn equation_row() {
   ...
   ";
   test_ClearSpeak("nn", "ClearSpeak_MultiLineLabel", "Row", expr, "2 rader; \
                rad 1; x pluss y er lik 7; \
                rad 2; 2 x pluss 3 y; er lik 17");
}
...
fn equation_step() {
   ...
   ";
   test_ClearSpeak("nn", "ClearSpeak_MultiLineLabel", "Step", expr, "2 steg; \

...
fn common_fraction_half() {
    ...
    test("nn", "SimpleSpeak", expr, "1 halv");
}
...
fn not_SimpleSpeak_common_fraction_tenths() {
    ...
    test("nn", "SimpleSpeak", expr, "89 over 10");
}
...
fn non_simple_fraction() {
    ...
    <math>
        ...
        <mi>x</mi><mo>-</mo><mi>y</mi></mrow>
                            ...
                            ";
    test("nn", "SimpleSpeak", expr, "brøk, x pluss y, over, x minus y, slutt brøk");
}
...
fn nested_fraction() {
    ...
    <math>
        ...
        <mi>x</mi><mo>-</mo><mi>y</mi></mrow>
                            ...
                            ";
    test("nn", "SimpleSpeak", expr, "brøk, x pluss, brøk, 1 over y, slutt brøk; over, x minus y, slutt brøk");
}
...
fn deeply_nested_fraction_msqrt() {
    ...
    <math>
        ...
        <mi>x</mi><mo>-</mo><mi>y</mi></mrow>
                            ...
                            ";
    test("nn", "SimpleSpeak", expr, "brøk, x pluss, kvadratroten av 1 over y; slutt rot; over, x minus y, slutt brøk");
}
...
fn deeply_nested_fraction_mrow_msqrt() {
    ...
    <math>
        ...
        <mi>x</mi><mo>-</mo><mi>y</mi></mrow>
                            ...
                            ";
    test("nn", "SimpleSpeak", expr, "brøk, x pluss, kvadratroten av 2 pluss 1 over y; slutt rot; over, x minus y, slutt brøk");
}
    ...
    <math>
        ...
        <mrow>
            <mi>x</mi><mo>-</mo><mi>y</mi></mrow>
                            ...
                            ";
    test("nn", "SimpleSpeak", expr, "brøk, x over, x minus y, slutt brøk");
}
    ...
    <math>
        <mfrac>
            ...
            <mrow> <mi>x</mi></mrow>
                            ...
                            ";
    test("nn", "SimpleSpeak", expr, "brøk, x minus y, over x, slutt brøk");
}
...
fn frac_with_units() {
    ...
    test("nn", "SimpleSpeak", expr, "62 miles per time");
}
...
fn singular_frac_with_units() {
    ...
    test("nn", "SimpleSpeak", expr, "1 gallon per mile");
}
...
fn number_in_numerator_with_units() {
    ...
    test("nn", "SimpleSpeak", expr, "3 gallon per mile");
}
...
fn units_with_powers() {
    ...
    test("nn", "SimpleSpeak", expr, "3 meter per sekund i andre");
}
...
fn mixed_number() {
    ...
    test("nn", "SimpleSpeak", expr, "3 og 1 halv");
}
...
fn explicit_mixed_number() {
    ...
    test("nn", "SimpleSpeak", expr, "3 og 1 åttedel");
}
...
fn mixed_number_big() {
    ...
    test("nn", "SimpleSpeak", expr, "3 og 7 over 83");
}
...
fn simple_text() {
    ...
    test("nn", "SimpleSpeak", expr, "rise over run");
}
...
fn number_and_text() {
    ...
    test("nn", "SimpleSpeak", expr, "brøk, 2 miles, over, 3 gallons, slutt brøk");
}
...
fn binomial() {
    ...
    test("nn", "SimpleSpeak", expr, "2 ganger 7 over 3");
}
...
fn binomial_non_simple_top() {
    ...
    test("nn", "SimpleSpeak", expr, "2 ganger, binomialkoeffisient n pluss 7 over 3");
}
...
fn binomial_non_simple_bottom() {
    ...
    test("nn", "SimpleSpeak", expr, "2 ganger, 7 over k pluss 3 slutt binomialkoeffisient");
}
...
fn binomial_non_simple_top_and_bottom() {
    ...
    test("nn", "SimpleSpeak", expr, "2 ganger; binomialkoeffisient n pluss 7 over k pluss 3 slutt binomialkoeffisient");
}

...
fn trig_names() {
    ...
    test("nn", "SimpleSpeak", expr, "sinus av x pluss cosinus av y pluss tangens av z pluss sekans av alfa, pluss cosekans av fi, pluss cotangens av fi");
}
...
fn hyperbolic_trig_names() {
    ...
    test("nn", "SimpleSpeak", expr, "sinus hyperbolicus av x, pluss cosinus hyperbolicus av y, pluss tangens hyperbolicus av z, pluss, sekans hyperbolicus av alfa, pluss cosekans hyperbolicus av fi, pluss cotangens hyperbolicus av fi");
}
...
fn inverse_trig() {
    ...
    test("nn", "SimpleSpeak", expr, "invers sinus av x");
}

#[test]
fn trig_squared() {
    let expr = "<math><msup><mi>sin</mi><mn>2</mn></msup><mi>x</mi></math>";
    test("nn", "SimpleSpeak", expr, "sinus i andre av x");
}

#[test]
fn trig_cubed() {
    let expr = "<math><msup><mi>tan</mi><mn>3</mn></msup><mi>x</mi></math>";
    test("nn", "SimpleSpeak", expr, "tangens i tredje av x");
}

#[test]
fn trig_fourth() {
    let expr = "<math><msup><mi>sec</mi><mn>4</mn></msup><mi>x</mi></math>";
    test("nn", "SimpleSpeak", expr, "sekans opphøyd i 4, av x");
}
...
fn trig_power_other() {
    ...
    test("nn", "SimpleSpeak", expr, "sinus hyperbolicus opphøyd i n minus 1, av x");
}

#[test]
fn simple_log() {
    let expr = "<math> <mrow>  <mi>log</mi><mi>x</mi></mrow> </math>";
    test("nn", "SimpleSpeak", expr, "log av x");
}

#[test]
fn normal_log() {
    let expr = "<math><mrow><mi>log</mi><mrow><mo>(</mo><mrow><mi>x</mi><mo>+</mo><mi>y</mi></mrow><mo>)</mo></mrow></mrow></math>";
    test("nn", "SimpleSpeak", expr, "log av; startparentes; x pluss y; sluttparentes");
}

#[test]
fn simple_log_with_base() {
    let expr = "<math> <mrow>  <msub><mi>log</mi><mi>b</mi></msub><mi>x</mi></mrow> </math>";
    test("nn", "SimpleSpeak", expr, "logaritmen med grunntall b, av x");
}
...
fn normal_log_with_base() {
    ...
    test("nn", "SimpleSpeak", expr, "logaritmen med grunntall b, av; startparentes; x pluss y; sluttparentes");
}
...
fn explicit_function_call_with_parens() {
    ...
    test("nn", "SimpleSpeak", expr, "t av x");
}
...
fn explicit_times_with_parens() {
    let expr = "<math><mrow><mi>t</mi><mo>&#x2062;</mo><mrow><mo>(</mo><mi>x</mi><mo>)</mo></mrow></mrow></math>";
    test("nn", "SimpleSpeak", expr, "t ganger x");
}
...
fn times_following_paren() {
    ...
    test("nn", "SimpleSpeak", expr, "2 ganger 3");
}
...
/*
    ...
    */
    ...
    fn no_parens_number() {
        ...
        test("nn", "SimpleSpeak", expr, "25 ganger x");
    }
    ...
    fn no_parens_monomial() {
        ...
        test("nn", "SimpleSpeak", expr, "b; startparentes; x y, sluttparentes");
    }
    ...
    fn no_parens_negative_number() {
        ...
        test("nn", "SimpleSpeak", expr, "2 pluss minus 2");
    }
    ...
    fn no_parens_negative_number_with_var() {
        ...
        test("nn", "SimpleSpeak", expr, "minus 2 x, pluss 1");
    }
    ...
    fn parens_superscript() {
        ...
        test("nn", "SimpleSpeak", expr, ", startparentes; 2 x, sluttparentes i andre");
    }
    ...
    fn no_parens_fraction() {
        ...
        test("nn", "SimpleSpeak", expr, "2 pluss 1 halv");
    }
    ...
    test("nn", "SimpleSpeak",expr, "det åpne intervallet fra c til d");
}
...
#[test]
    ...
    test("nn", "SimpleSpeak",expr, "det halvåpne intervallet fra og med c til d");
}
...
fn parens_interval_open_closed() {
    ...
    test("nn", "SimpleSpeak",expr,"det halvåpne intervallet fra c til og med d");
}
...
fn parens_interval_closed_closed() {
    ...
    test("nn", "SimpleSpeak",expr, "det lukkede intervallet fra c til d");
}

...
fn squared() {
    ...
    test("nn", "SimpleSpeak", expr, "x i andre");
}
...
fn cubed() {
    ...
    test("nn", "SimpleSpeak", expr, "x i tredje");
}
...
#[test]
    fn ordinal_power() {
        ...
        test("nn", "SimpleSpeak", expr, "x opphøyd i 4");
    }
...
fn simple_mi_power() {
  ...
  test("nn", "SimpleSpeak", expr, "x opphøyd i n");
}
...
fn zero_power() {
    ...
    test("nn", "SimpleSpeak", expr, "x opphøyd i 0");
}
...
fn decimal_power() {
    ...
    test_prefs("nn", "SimpleSpeak", vec![("DecimalSeparators", ","), ("BlockSeparators", ".")], expr, "x opphøyd i 2,0");
}
...
fn non_simple_power() {
    ...
    test("nn", "SimpleSpeak", expr, "3 opphøyd i y pluss 2");
}
...
fn negative_power() {
    ...
    test("nn", "SimpleSpeak", expr, "x opphøyd i minus 2");
}
...
fn simple_fraction_power() {
  ...
  test("nn", "SimpleSpeak", expr, "x opphøyd i 1 tredjedel");
}
...
fn nested_squared_power_with_coef() {
  ...
  test("nn", "SimpleSpeak", expr, "3 opphøyd i 2 x i andre");
}
...
fn nested_squared_power_with_neg_coef() {
  ...
  test("nn", "SimpleSpeak", expr, "3 opphøyd i minus 2 x i andre");
}
...
fn nested_number_times_squared() {
  ...
  test("nn", "SimpleSpeak", expr, "e opphøyd i 1 halv x i andre");
}
...
fn nested_negative_number_times_squared() {
  ...
  test("nn", "SimpleSpeak", expr, "e opphøyd i minus 1 halv x i andre");
}
...
fn nested_expr_to_tenth() {
  ...
  test("nn", "SimpleSpeak", expr, "3 opphøyd i 3 opphøyd i 10");
}
...
fn nested_non_simple_squared_exp() {
  ...
  test("nn", "SimpleSpeak", expr, "3 opphøyd i, startparentes; x pluss 1; sluttparentes i andre");
}
...
fn nested_complex_power() {
  ...
  test("nn", "SimpleSpeak", expr, "e opphøyd i minus 1 halv ganger; startparentes; brøk, x minus my, over sigma, slutt brøk; sluttparentes i andre");
}
...
fn default_power() {
  ...
  test("nn", "SimpleSpeak", expr, "t opphøyd i brøk, b pluss 1, over 3, slutt brøk");
}

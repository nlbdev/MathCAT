...
fn limit() {
    ...
    test("nn", "SimpleSpeak", expr, "grenseverdien når x går mot 0, av, brøk, sinus av x, over x, slutt brøk");
...
fn limit_from_below() {
    ...
    test("nn", "SimpleSpeak", expr, "grenseverdien når x går fra venstre mot 0, av sinus av x");
}
...
fn binomial_mmultiscripts() {
    ...
    test("nn", "SimpleSpeak", expr, "n over m");
}
...
fn permutation_mmultiscripts() {
    ...
    test("nn", "SimpleSpeak", expr, "antallet permutasjoner av k elementer av n");
}
...
fn tensor_mmultiscripts() {
    ...
    test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Verbose")], expr,
            "stor r med 4 høyre indeks, senket i, hevet j, senket k, senket l");
    test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Medium")], expr,
            "stor r med 4 høyre indeks, senket i, hevet j, senket k, senket l");
}
...
fn prime() {
    ...
    test("nn", "SimpleSpeak", expr, "x primtegn");
}

#[test]
fn given() {
    let expr = "<math><mi>P</mi><mo>(</mo><mi>A</mi><mo>|</mo><mi>B</mi><mo>)</mo></math>";
    test("nn", "SimpleSpeak", expr, "stor p; startparentes; stor a, gitt stor b; sluttparentes");
    test("nn", "ClearSpeak", expr,  "stor p; startparentes; stor a, gitt stor b; sluttparentes");  // not good, but follows the spec
}
...
fn simple_msubsup() {
    ...
    test("nn", "ClearSpeak", expr, "x, senket k, opphøyd i i");
}

#[test]
fn non_simple_msubsup() {
  let expr = "<math><msubsup><mi>i</mi><mrow><mi>j</mi><mo>&#x2212;</mo><mn>2</mn></mrow><mi>k</mi></msubsup></math>";
  test("nn", "SimpleSpeak", expr, "i senket j minus 2 slutt senket, opphøyd i k");
  test("nn", "ClearSpeak", expr, "i senket j minus 2 slutt senket, opphøyd i k");
  test_prefs("nn", "SimpleSpeak", vec![("Impairment", "LearningDisability")], expr,
...
fn ignore_period() {
    ...
    test("nn", "SimpleSpeak", expr, "stor p; startparentes; stor a and stor b; sluttparentes; er lik; stor p; startparentes; stor a snitt stor b; sluttparentes; er lik, stor p av stor a, stor p av stor b");
}

#[test]
fn ignore_mtext_period() {
    let expr = "<math><mrow><mrow><mo>{</mo><mn>2</mn><mo>}</mo></mrow><mtext>.</mtext></mrow></math>";
    test("nn", "SimpleSpeak", expr, "mengden 2");
}
...
fn ignore_comma() {
    ...
    test("nn", "SimpleSpeak", expr, "fi av x er lik, c ganger, e opphøyd i minus h i andre, x i andre");
}
...
fn ignore_period_and_space() {
    ...
    test("nn", "ClearSpeak", expr, "phi of x is equal to; c, e raised to the negative h squared x squared power");
}
...
fn bug_199_2pi() {
  ...
  test("nn", "SimpleSpeak",expr, "det halvåpne intervallet fra og med 0 til 2 pi");
}

#[test]
fn caret_and_hat() {
  let expr = "<math><mi>x</mi><mo>^</mo><mn>2</mn><mo>+</mo><mover><mi>y</mi><mo>^</mo></mover></math>";
  test("nn", "SimpleSpeak",expr, "x hatt 2 pluss y hatt");
}

#[test]
fn mn_with_space() {
  let expr = "<math><mn>1 234 567</mn></math>";
  test_prefs("nn", "SimpleSpeak", vec![("DecimalSeparators", "."), ("BlockSeparators", " ,")], expr, "1234567");
}

#[test]
fn mn_with_block_and_decimal_separators() {
  let expr = "<math><mn>1.234,56</mn></math>";                                       // may want to change this for another language
  test_prefs("nn", "SimpleSpeak", vec![("DecimalSeparators", ","), ("BlockSeparators", " .")], expr, "1234,56");
}

#[test]
fn divergence() {
  let expr = "<math><mo>&#x2207;</mo><mo>&#xB7;</mo><mi mathvariant='normal'>F</mi></math>";                                       // may want to change this for another language
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "div stor f");
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Verbose")], expr, "divergensen til stor f");
}
...
fn curl() {
  ...
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "curl stor f");
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Verbose")], expr, "curlen til stor f");
}
...
fn gradient() {
  ...
  // may want to change this for another language
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "gradienten til stor f");
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Verbose")], expr, "gradienten til stor f");
}
...
fn literal_speak() {
  ...
  test("nn", "LiteralSpeak", expr, "stor a høyrepil, perpendicular to, stor b høyrepil");
}
...
fn literal_speak_with_name() {
  ...
  test("nn", "LiteralSpeak", expr, "forced f, venstreparentes; x utropstegn; høyreparentes");
}
...
fn literal_speak_with_property() {
  ...
  test("nn", "LiteralSpeak", expr, "f, venstreparentes; x utropstegn; høyreparentes");
}
...
fn literal_intent_property() {
  ...
  test("nn", "SimpleSpeak", expr, "stor a høyrepil, perpendicular to, stor b høyrepil");
}
...
fn literal_intent_property_with_name() {
  ...
  test("nn", "SimpleSpeak", expr, "forced f; startparentes; x utropstegn; sluttparentes");
}

    ...
    <math xmlns='http://www.w3.org/1998/Math/MathML'>
      ...
      <mrow><mo>(</mo>
        ...
        <mo>)</mo></mrow></mrow>
                                ...
                                ";
    test("nn", "ClearSpeak",  expr, "1 ganger 1 matrise med element 3");
    test("nn", "SimpleSpeak", expr, "1 ganger 1 matrise med element 3");
}
    ...
    <math xmlns='http://www.w3.org/1998/Math/MathML'>
      ...
      <mrow><mo>|</mo>
        ...
        <mo>|</mo></mrow></mrow>
                                ...
                                ";
    test("nn", "ClearSpeak",  expr, "1 ganger 1 determinant med element 3");
    test("nn", "SimpleSpeak", expr, "1 ganger 1 determinant med element 3");
}
...
fn matrix_1x2() {
    ...
    <math xmlns='http://www.w3.org/1998/Math/MathML'>
      ...
      <mo>)</mo></mrow></mrow>
                                ...
                                ";
    test("nn", "ClearSpeak",  expr, "1 ganger 2 rad-matrise; 3, 5");
    test("nn", "SimpleSpeak", expr, "1 ganger 2 rad-matrise; 3, 5");
}
...
fn matrix_1x3() {
    ...
    <math xmlns='http://www.w3.org/1998/Math/MathML'>
      ...
      <mo>)</mo></mrow></mrow>
                                ...
                                ";
    test("nn", "ClearSpeak", expr, "1 ganger 3 rad-matrise; minus x, 5, 12");
    test("nn", "SimpleSpeak", expr, "1 ganger 3 rad-matrise; minus x, 5, 12");
}
...
fn matrix_2x1_not_simple() {
    ...
    <math xmlns='http://www.w3.org/1998/Math/MathML'>
      ...
      <mo>)</mo></mrow></mrow>
                                ...
                                ";
    test("nn", "ClearSpeak", expr, "2 ganger 1 kolonne-matrise; rad 1; x pluss 1; rad 2; x minus 1");
    test("nn", "SimpleSpeak", expr, "2 ganger 1 kolonne-matrise; rad 1; x pluss 1; rad 2; x minus 1");
}
#[test]
fn matrix_3x1_not_simple() {
    ...
    test("nn", "SimpleSpeak", expr, "3 ganger 1 kolonne-matrise; \
            rad 1; x; \
            rad 2; a; \
            rad 3; brøk, x over, x pluss 1, slutt brøk");
    test("nn", "ClearSpeak",  expr, "3 ganger 1 kolonne-matrise; \
            rad 1; x; \
            rad 2; a; \
...
fn determinant_2x2() {
    ...
    test("nn", "ClearSpeak",  expr, "2 ganger 2 determinant; rad 1; 2, 1; rad 2; 7, 5");
    test("nn", "SimpleSpeak", expr, "2 ganger 2 determinant; rad 1; 2, 1; rad 2; 7, 5");
}
...
fn matrix_2x3() {
    ...
    <math display='block' xmlns='http://www.w3.org/1998/Math/MathML'>
      ...
      <mo>]</mo></mrow></mrow>
                                ...
                                ";
    test("nn", "ClearSpeak",  expr, "2 ganger 3 matrise; rad 1; 3, 1, 4; rad 2; 0, 2, 6");
    test("nn", "SimpleSpeak", expr, "2 ganger 3 matrise; rad 1; 3, 1, 4; rad 2; 0, 2, 6");
}
      ...
      <mrow><mo>[</mo>
        ...
        <mtr>
          ...
          <mn>3</mn>
                                ...
                                ";
    test("nn", "ClearSpeak",  expr, "3 ganger 1 kolonne-matrise; 1; 2; 3");
    test("nn", "SimpleSpeak", expr, "3 ganger 1 kolonne-matrise; 1; 2; 3");
}
...
fn matrix_4x1() {
    ...
    <math xmlns='http://www.w3.org/1998/Math/MathML'>
      ...
      <mo>)</mo></mrow></mrow>
                                ...
                                ";
    test("nn", "ClearSpeak",  expr, "4 ganger 1 kolonne-matrise; rad 1; 3; rad 2; 6; rad 3; 1; rad 4; 2");
    test("nn", "SimpleSpeak", expr, "4 ganger 1 kolonne-matrise; rad 1; 3; rad 2; 6; rad 3; 1; rad 4; 2");
}
...
fn matrix_1x4() {
    ...
    <math xmlns='http://www.w3.org/1998/Math/MathML'>
      ...
      <mo>)</mo></mrow></mrow>
                                ...
                                ";
    test("nn", "ClearSpeak",  expr, "1 ganger 4 rad-matrise; kolonne 1; 3, kolonne 2; 6, kolonne 3; 1, kolonne 4; 2");
    test("nn", "SimpleSpeak", expr, "1 ganger 4 rad-matrise; kolonne 1; 3, kolonne 2; 6, kolonne 3; 1, kolonne 4; 2");
}
...
fn matrix_4x4() {
    ...
    <math xmlns='http://www.w3.org/1998/Math/MathML'>
      ...
      <mo>)</mo></mrow></mrow>
                                ...
                                ";
    test("nn", "ClearSpeak",  expr, "4 ganger 4 matrise; \
    ...
    test("nn", "SimpleSpeak", expr, "4 ganger 4 matrise; \
          rad 1; kolonne 1; 0, kolonne 2; 3, kolonne 3; 4, kolonne 4; 3; \
          rad 2; kolonne 1; 2, kolonne 2; 1, kolonne 3; 0, kolonne 4; 9; \
          rad 3; kolonne 1; 3, kolonne 2; 0, kolonne 3; 2, kolonne 4; 1; \
          rad 4; kolonne 1; 6, kolonne 2; 2, kolonne 3; 9, kolonne 4; 0");}
...
fn simple_absolute_value() {
  ...
  test("nn", "SimpleSpeak", expr, "absoluttverdien av x");
  test("nn", "ClearSpeak",  expr, "absoluttverdien av x");
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Terse"), ("ClearSpeak_AbsoluteValue", "Auto")], expr, "absoluttverdien av x");
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Verbose"), ("ClearSpeak_AbsoluteValue", "AbsEnd")],
...
let expr = "<math>
  ...
  test("nn", "ClearSpeak", expr, "absoluttverdien av x pluss 1");
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Terse"), ("ClearSpeak_AbsoluteValue", "AbsEnd")],
...
fn simple_cardinality_value() {
  ...
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Medium"), ("ClearSpeak_AbsoluteValue", "Cardinality")], expr,
...
let expr = "<math display='block' xmlns='http://www.w3.org/1998/Math/MathML'>
  ...
  test_ClearSpeak("nn", "ClearSpeak_Matrix", "SpeakColNum",
...
let expr = "<math display='block' xmlns='http://www.w3.org/1998/Math/MathML'>
  ...
  test_ClearSpeak("nn", "ClearSpeak_Matrix", "SilentColNum",
...
let expr = "<math display='block' xmlns='http://www.w3.org/1998/Math/MathML'>
  ...
  test_ClearSpeak("nn", "ClearSpeak_Matrix", "EndMatrix",
...
let expr = "<math display='block' xmlns='http://www.w3.org/1998/Math/MathML'>
  ...
  test_ClearSpeak("nn", "ClearSpeak_Matrix", "Vector",
        expr, "2 ganger 2 matrise; rad 1; 2, 1; rad 2; 7, 5");
}
...
let expr = "<math display='block' xmlns='http://www.w3.org/1998/Math/MathML'>
  ...
  test_ClearSpeak("nn", "ClearSpeak_Matrix", "EndVector",
        expr, "2 ganger 2 matrise; rad 1; 2, 1; rad 2; 7, 5; slutt matrise");
}
...
fn matrix_binomial() {
  ...
  test_ClearSpeak("nn", "ClearSpeak_Matrix", "Combinatorics", expr, "3 over 2");
}
...
fn diagonal_matrix() {
  ...
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Terse")],

...
fn salt() {
  ...
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "stor n a, stor c l");
}

#[test]
fn water() {
  let expr = "<math><msub><mi>H</mi><mn>2</mn></msub><mi>O</mi></math>";
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Terse")], expr, "stor h, 2, stor o");
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Medium")], expr, "stor h, senket 2, stor o");
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Verbose")], expr, "stor h, nedre indeks 2, stor o");
}

#[test]
fn carbon() {
  let expr = "<math><mi>C</mi></math>";     // not enough to trigger recognition
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "stor c");
}
...
fn sulfate() {
  ...
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Medium")], expr, "start hakeparentes; stor s, stor o, senket 4; slutt hakeparentes hevet 2 minus");
}
...
fn aluminum_sulfate() {
  ...
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Terse")], expr, "stor a l, 2; startparentes; stor s, stor o, 4; sluttparentes 3");
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Medium")], expr, "stor a l, senket 2; startparentes; stor s, stor o, senket 4; sluttparentes senket 3");
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Verbose")], expr, "stor a l, nedre indeks 2; startparentes; stor s, stor o, nedre indeks 4; sluttparentes nedre indeks 3");
}
...
fn ethanol_bonds() {
  ...
  test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Terse")], expr, "stor c, stor h, 3; enkeltbinding stor c, stor h, 2; enkeltbinding stor o, stor h");
...
fn dichlorine_hexoxide() {
  ...
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Medium")], 
  ...
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Verbose")], 
...
fn ethylene_with_bond() {
  ...
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "stor h, 2, stor c, dobbeltbinding stor c, stor h, 2");
}
...
fn ferric_chloride_aq() {
  ...
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "stor f e, stor c l, 3; løst i vann");
  }
...
fn beta_decay() {
  let expr = "<math>
    ...
    test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Terse")], expr,
      "14, 6, stor c; danner, 14, 7, stor n; pluss 0, minus 1, e");
    test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Medium")], expr,
      "hevet 14, senket 6, stor c; reaksjon danner; hevet 14, senket 7, stor n; pluss, hevet 0, senket minus 1, e");
    test_prefs("nn", "ClearSpeak", vec![("Verbosity", "Verbose")], expr,
...
fn mhchem_so4_2plus() {
  ...
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "stor s; stor o, 4, 2 pluss");
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Medium")], expr, "stor s; stor o, senket 4, hevet 2 pluss");
  test_prefs("nn", "SimpleSpeak", vec![("Verbosity", "Verbose")], expr, "stor s; stor o, nedre indeks 4, øvre indeks 2 pluss");
}
